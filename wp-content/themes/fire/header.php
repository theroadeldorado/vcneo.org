    ...
    <section class="bg-purple-900 py-6">
      <div class="container px-4 mx-auto">
        ...
        <div class="max-w-4xl mx-auto mb-12">
          <h2 class="text-orange-50 text-2xl mb-8">The Village of Hope is a non-profit initiative that empowers 18-24 year-old adults to gain the professional skills they need to secure a meaningful and sustaining career with a family-supporting salary through the provision of stable housing in an intentional community while building equity and skills focused on home ownership.</h2>
